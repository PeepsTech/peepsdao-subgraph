...
import { Contract, NewContract } from "../generated/Contract/Contract"
...
export function handleNewContract(event: NewContract): void {
  ...
  entity.peepsId = event.params.peepsId
  entity._summoner = event.params._summoner
  entity.peepsmoloch = event.params.newPeeps
  entity._minDonation = event.params._minDonation
  ...
  //
  // - contract.createPeepsMoloch(...)
  // - contract.getContractCount(...)
  // - contract.getDeployedPeepsMoloch(...)
  // - contract.peepsmolochs(...)
}
