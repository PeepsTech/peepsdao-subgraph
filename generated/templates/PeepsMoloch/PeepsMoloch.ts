...
export class FeeWithdraw extends EthereumEvent {
...
export class PeepsMoloch extends SmartContract {
  ...
  adminFee(): BigInt {
    let result = super.call("adminFee", []);

    return result[0].toBigInt();
  }

  try_adminFee(): CallResult<BigInt> {
    let result = super.tryCall("adminFee", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  peepsWallet(): Address {
    let result = super.call("peepsWallet", []);

    return result[0].toAddress();
  }

  try_peepsWallet(): CallResult<Address> {
    let result = super.tryCall("peepsWallet", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
